...
namespace RasManagement.Controllers
{
    ...
    public class ApprovalController : BaseController<Approval, ApprovalRepository, int>
    {
        ...
        public ApprovalController(ApprovalRepository approvalRepository) : base(approvalRepository)
        {
            this.approvalRepository = approvalRepository;
        }
      
        [HttpGet("accountId")]
        public async Task<IActionResult> GetApprovalsByAccount(string accountId)
        {
            var get = await approvalRepository.GetApprovalsByAccount(accountId);
            if (get != null)
            {
