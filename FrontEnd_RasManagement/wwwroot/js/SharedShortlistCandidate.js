    ...
    columns: [
...

      {
        ...
        render: function (data, type, row) {
          ...
          if (data == "cvberca"){
            // sessionStorage.setItem('myData', row.accountId);
            // const storedString = sessionStorage.getItem('myData');
            // const storedJsonResponse = JSON.parse(storedString);
            // console.log(storedJsonResponse);
            // \'' + row.accountId + '\'
...
function GetSetData(accountId){
  ...
  // const storedString = sessionStorage.getItem('data');
  // const storedJsonResponse = JSON.parse(storedString);
...
//   window.location.href = "/Share/GenerateCvShared?accountId=" + accountId;
