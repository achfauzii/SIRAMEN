...
$(document).ready(function () {
    ...
    table = $('#TB_ProjectHistory').DataTable({
        "ajax": {
            url: "http://192.168.25.131:9001/api/ProjectHistory/accountId?accountId=" + accid,
            type: "GET",
            "datatype": "json",
            "dataSrc": "data",
            headers: {
...
function Save() {
   ...
   /* var jobSpecValue = $('#JobSpec').val();
    ...
    $.ajax({
        type: 'POST',
        url: 'http://192.168.25.131:9001/api/ProjectHistory',
...
function GetById(projectHistoryId) {
    //debugger;
    $.ajax({
        url: "http://192.168.25.131:9001/api/ProjectHistory/" + projectHistoryId,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        headers: {
