...
$(document).ready(function () {
    ...
    $.ajax({
        url: "https://rasmanagement-001-site1.atempurl.com/api/Qualification/accountId?accountId=" + accid,
        type: 'GET',
        dataType: 'json',
        headers: {
...
/*      debugger;
    ...
    $.ajax({
        type: 'POST',
        url: 'https://rasmanagement-001-site1.atempurl.com/api/Qualification',
