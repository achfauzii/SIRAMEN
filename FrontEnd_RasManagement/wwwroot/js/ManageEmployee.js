...
$(document).ready(function () {
    ...
    /*const selectPosition = $("#positionEmp");
    ...
    $(
        "input[required], input[required_], input[requiredContract],select[requiredContract], select[required], select[required_]"
    ).each(function () {
...
function UpdateContract() {
    table = $("#dataTableEmployee").DataTable();
    var isValid = true;
    $("input[requiredContract],select[requiredContract]").each(function () {
        var input = $(this);
        if (!input.val()) {
