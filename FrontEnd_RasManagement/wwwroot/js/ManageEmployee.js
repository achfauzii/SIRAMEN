                    ...
                    render: function (data, type, row) {
                        ...
                        if (placementStatus == "Idle") {
                            /*placementStatus =
                                ...
                                row.accountId +
                                "', 'Idle')\">Idle</button>";*/
                            placementStatus = '<span class="badge badge-pill badge-warning" style="outline: none; border:none">Idle</span>'
                        } else {
                            /*placementStatus =
                            ...
                            placementStatus = '<span class="badge badge-pill badge-success" style="outline: none; border:none">' + placementStatus + '</span>'
                        }
