        ...
        },
        {
          ...
          render: function (data, type, row) {
            ...
            if (row.assetsManagements && row.assetsManagements.length > 0) {
              tulisanButton =
                '<button class="btn btn-success btn-sm rounded-pill" data-placement="left" data-toggle="modal" data-animation="false" title="Assets" onclick="return GetByIdAsset(\'' +
                row.accountId +
                "')\">" +
                "View Data" +
                "</button>";
              ...
              tulisanButton =
                '<button class="btn btn-secondary btn-sm rounded-pill" data-placement="left" data-toggle="modal" data-animation="false" title="Assets" onclick="return GetByIdAsset(\'' +
                row.accountId +
                "')\">" +
                "Data Empty" +
                "</button>";
...
function GetByIdPlacement(accountId, placementStatus) {
  ...
  $.ajax({
    url:
      "http://192.168.25.243:9001/api/EmployeePlacements/accountId?accountId=" +
      accountId,
    type: "GET",
    contentType: "application/json; charset=utf-8",
    dataType: "json",
...
function GetByIdAsset(assetsManagementId) {
  ...
  $.ajax({
    url:
      "http://192.168.25.243:9001/api/Assets/accountId?accountId=" +
      assetsManagementId,
    type: "GET",
    contentType: "application/json; charset=utf-8",
    dataType: "json",
