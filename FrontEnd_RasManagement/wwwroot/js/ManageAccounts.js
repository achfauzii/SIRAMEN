            ...
            },
            {
                ...
                "render": function (data, type, row) {
                    ...
                    if (row.assetsManagements && row.assetsManagements.length > 0) {
                        tulisanButton = '<button class="btn btn-success btn-sm rounded-pill" data-placement="top" data-toggle="modal" data-animation="false" data-tooltip="tooltip" title="Detail Assets" onclick="return GetByIdAsset(\'' + row.accountId + '\')">' + "View Asset's Data" + '</button>';

                    } else {
                        tulisanButton = '<button class="btn btn-secondary btn-sm rounded-pill" data-placement="top" data-toggle="modal" data-animation="false" data-tooltip="tooltip" title="Detail Assets" onclick="return GetByIdAsset(\'' + row.accountId + '\')">' + "Data Not Submitted" + '</button>';
                    }
