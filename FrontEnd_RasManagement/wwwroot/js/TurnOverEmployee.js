        ...
        { data: "address" },
        {
          render: function (data, type, row) {
            ...
            if (placementStatus === "Blacklist") {
              return (
                '<span type="button" class="badge badge-pill badge-danger"  data-toggle="modal" data-target="#infoTurnOver" onclick=" return showDescription(\'' +
                row.deptName +
                "', '" +
                row.description +
                "', '" +
              ...
              return (
                '<span type="button" class="badge badge-pill badge-primary"  data-toggle="modal" data-target="#infoTurnOver" onclick=" return showDescription(\'' +
                row.deptName +
                "', '" +
                row.description +
                "', '" +
