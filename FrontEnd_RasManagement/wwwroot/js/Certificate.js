...
$(document).ready(function () {
    ...
    table = $('#TB_Certificate').DataTable({
        "ajax": {
            url: "http://192.168.25.131:9001/api/Certificate/accountId?accountId=" + accid,
            type: "GET",
            "datatype": "json",
            "dataSrc": "data",
            headers: {
...
function GetById(CertificateId) {
    //debugger;
    $.ajax({
        url: "http://192.168.25.131:9001/api/Certificate/" + CertificateId,
        type: "GET",
...
function Save() {
    ...
    $.ajax({
        type: 'POST',
        url: 'http://192.168.25.131:9001/api/Certificate',
