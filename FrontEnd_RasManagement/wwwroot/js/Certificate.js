...
function GetById(CertificateId) {
    //debugger;
    $.ajax({
        url: "https://https://rasmanagement-001-site1.atempurl.com/api/Certificate/" + CertificateId,
        type: "GET",
...
function Save() {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://https://rasmanagement-001-site1.atempurl.com/api/Certificate',
