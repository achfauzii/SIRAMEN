...
function loadData() {
  ...
  $.ajax({
    url:"http://202.69.99.67:9001/api/Employees/accountId?accountId=" +
      accountId,
    type: "GET",
    ...
    success: function (result) {
      ...
      $.ajax({
        url:"http://202.69.99.67:9001/api/Educations/accountId?accountId=" +
          accountId,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
      ...
      $.ajax({
        url:"http://202.69.99.67:9001/api/Qualification/accountId?accountId=" +
          accountId,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
      ...
      $.ajax({
        url:"http://202.69.99.67:9001/api/Certificate/accountId?accountId=" +
          accountId,
        type: "GET",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
