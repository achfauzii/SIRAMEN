...
namespace FrontEnd_RasManagement.Services
{
  public class MailService : IMailService
  {
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;""
                                                                      ...
                                                                      <table style=""border-collapse: separate !important; width: 100%; overflow: hidden;""
                                                                bgcolor=""#ffffff"">
    ...
    public async Task SendEmailNotifTimesheet(EmployeeData employee)
        {
            DateTime today = DateTime.Today;
            string formattedDate = today.ToString("dd MMMM yyyy", new System.Globalization.CultureInfo("id-ID"));
            for (int i = 0; i < employee.Email.Count; i++)
            {
                if (i == 5)
                {
                    Thread.Sleep(10000);
                }
                Console.WriteLine("Data Email: " + employee.Email[i]);
                var _email = new MimeMessage();
                _email.From.Add(new MailboxAddress(_mailSettings.DisplayName, _mailSettings.Mail));
                //_email.Sender = MailboxAddress.Parse(_mailSettings.Mail);
                _email.To.Add(MailboxAddress.Parse(employee.Email[i]));

                _email.Subject = "Remember Input TimeSheet " + employee.Fullname[i] + "!";
                var builder = new BodyBuilder();
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style = ""line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;""
                                                                    ...
                                                                    <center>
                                                                        <!-- <img class=""w-24"" src=""https://i.postimg.cc/NjXnXhKd/Pngtree-happy-birthday-vector-text-art-6498386.png"" style=""height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 300px; border-style: none; border-width: 0;"" width=""96""> -->
                                                                        <p align = ""center"" id=""birthdayName"" style=""font-size: 20pt; font-family: Pristina""><b> Hallo " + employee.Fullname[i] + @"</b></p>
                                                                    </center>
                                                                    <br />

                                                                    <p style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0;""
                                                                       align=""center"">
                                                                           For your information, don't forget to fill in your Activity Timesheet
                                                                    </p>
