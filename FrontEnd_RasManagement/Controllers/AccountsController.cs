       ...
       public AccountsController(IMailService mailService)
        ...
        public async Task<IActionResult> ForgotPassword(string email)
        {
            ...
            try
            {
                ...
                string apiUrl = "202.69.99.67:9001/api/Accounts/ForgotPassword?email=" + email;
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    string resetUrl = $"202.69.99.67:9005/ResetPassword/{data.data}";
        ...
        /*  public async Task<IActionResult> ResetPassword()
          {
             ...
             *//* JwtSecurityTokenHandler tokenHandler = new JwtSecurityTokenHandler();
              ...
              try
              {
                  ...
                  // Konfigurasi URL API tujuan
                  string apiUrl = "202.69.99.67:9001/api/Accounts/UpdateForgotPassword";
        ...
        /* [HttpPost("register_employee")]
         public async Task<IActionResult> Register_Employee([FromForm] RegisterEmployeeViewModel model)
         {
             ...
             try
             {
                 ...
                 // Konfigurasi URL API tujuan
                 string apiUrl = "202.69.99.67:9001/api/Accounts/Register";
